...
int main()
{
	...
	char *msg = (char *) malloc (50); // buffer to take file name
	char *reply = (char *) malloc (50); // buffer to take file name
	char *err = (char *) malloc (60); // buffer to take file name

	int a = mknod (pipe, S_IFIFO | 0666, 0);
//	printf("%d", a);
